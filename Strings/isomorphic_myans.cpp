...
public:
    bool isIsomorphic(string s, string t) {
        ...
        for(int i = 0; i < s.size(); i++){
            ...
            //present s is not mapped to present t, that means s mapping was taken by something else or t was already taken before
...
// t is taken, so s is not mapped to anything
